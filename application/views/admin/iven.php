                                ...
                                <div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										...
										<div class="tinymce-single">
												<form action="<?php echo base_url(). 'halaman/aksi_iiven'; ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
											...
											<?php 
												$user = $this->db->query('SELECT * from iven');
												$no = 1;
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $u->jam_iven ?></td>
                                                <td><?= $u->lokasi_iven ?></td>
												<td><?= date('d F Y', strtotime($u->tgl_iven ))?></td>
												<td><a  href="<?=   base_url('gambar/berita/'.$u->foto_iven ) ?>" target="_blank" >Foto </a></td>
												<td><a  href="<?=   base_url('halaman/hapus/'.$u->id_iven ) ?>/iven"   >Hapus </a></td>

                                ...
                                <div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										...
										<div class="tinymce-single">
												<form action="<?php echo base_url(). 'halaman/aksi_ilogo'; ?>" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                ...
                                                                <input type="hidden" name="kategori" value="logo" class="form-control"  />
                                                            </div>
                                                        </div>
                                                    </div>  
                                                    <div class="form-group-inner">
                            ...
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
                                             <?php 
												$user = $this->db->query('SELECT * from atribut where kategori_atribut= "logo"');
												$no = 1;
											...
											<tr>
												...
												<td><a  href="<?=   base_url('halaman/hapuss/'.$u->id_atribut) ?>/atribut/ilogo"   >Hapus </a></td>
                                                </td>
                                            </tr>

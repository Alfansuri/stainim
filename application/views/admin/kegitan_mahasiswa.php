									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="sparkline12-hd">
											<div class="main-sparkline12-hd">
												<h1>Input kegitan mahasiswa</h1>
											</div>
										</div>

										<div class="tinymce-single">
												<?php echo form_open_multipart('halaman/aksi_upload_kegitan_mahasiswa');?>
                            ...
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
										<?php 
												$user = $this->db->query('SELECT * from galeri where kategori_galeri="kegitan_mahasiswa"');
												$no = 1;
                                            ...
                                            <tr>
                                                <td></td>
                                                <td><?php echo $no++ ?></td>
												<td><?=  $u->judul_galeri ?></td> 
												<td><a  href="<?=   base_url( $u->foto_galeri) ?> "   >Foto </a></td>
												<td><a  href="<?=   base_url('halaman/hapuss/'.$u->id_galeri) ?>/galeri/ikegitan_mahasiswa"   >Hapus </a></td>

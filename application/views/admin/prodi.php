                                ...
                                <div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										...
										<div class="tinymce-single">
												<form action="<?php echo base_url(). 'halaman/aksi_iprodi'; ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
                                             <?php 
												$user = $this->db->query('SELECT * from prodi');
												$no = 1;
											...
											<tr>
                                                ...
                                                <td><?= $u->judul_prodi ?></td> 
                                                <td><?= $u->seo_prodi ?></td> 
                                                <td> <?= date('d F Y', strtotime($u->tgl_prodi ))?></td> 
												<td><a  href="<?=    $u->video_prodi  ?>" target="_blank" >Video </a></td>
												<td><a  href="<?=   base_url( $u->foto_prodi ) ?>" target="_blank" >Foto </a></td>
												<td><a  href="<?=   base_url('halaman/hapus/'.$u->id_prodi ) ?>/prodi"   >Hapus </a></td>
                                                </td>
                                            </tr>

									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="sparkline12-hd">
											<div class="main-sparkline12-hd">
												<h1>Input Organisasi</h1>
											</div>
										</div>

										<div class="tinymce-single">
												<form action="<?php echo base_url(). 'halaman/aksi_ivisi'; ?>" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                ...
                                                                <input type="hidden" name="kategori" value="organisasi" class="form-control"  />
                                                            </div>
                                                        </div>
                                                    </div>  
                                                    <div class="form-group-inner">
                            ...
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
                                             <?php 
												$user = $this->db->query('SELECT * from atribut where kategori_atribut= "organisasi"');
												$no = 1;
											...
											<tr>
                                                <td></td>
                                                <td><?php echo $no++ ?></td>
                                                <td><?= $u->judul_atribut ?></td> 
                                                <td><?= $u->seo_atribut ?></td> 
                                                <td><?= $u->kategori_atribut ?></td> 
                                                <td> <?= date('d F Y', strtotime($u->tgl_atribut ))?></td> 
												<td><a  href="<?=   base_url('halaman/hapuss/'.$u->id_atribut) ?>/atribut/iorganisasi"   >Hapus </a></td>
                                                </td>
                                            </tr>

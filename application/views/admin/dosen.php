                                ...
                                <div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										...
										<div class="tinymce-single">
												...
												<?php echo form_open_multipart('halaman/aksi_upload_dosen');?>
                                                    <div class="form-group-inner">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Prodi</label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
										...
										<?php 
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $no++ ?></td>
												<td><?=  $u->nama_dosen ?></td> 
												<td><a  href="<?=   base_url( $u->foto_dosen) ?> "   ><?=  $u->foto_dosen ?> </a></td>
												<td><a  href="<?=   base_url('halaman/hapuss/'.$u->id_dosen) ?>/dosen/idosen"   >Hapus </a></td>
